				...
				<table class="table table-striped- table-bordered table-hover table-checkable" id="webPostTable">
					<thead>
                       	<tr>
                       		...
                       		<th class="dt-header">Print Date</th>
                       		<th class="dt-header">Publication Name</th>
                       		<th class="dt-header">Article Name</th>                      		                            
                          </tr>
                    	</thead>
                    <tbody>
                    </tbody>
...
<script type="text/javascript">
	...
	function getWebPostColumnData() {
		return [
			{ data : 'printId', width: '100px', render: editDeleteBankAccountRenderer, defaultContent : '', className: 'dt-left' },
			{ data : 'firstLastname', width: '125px', defaultContent : '', className: 'dt-left' },
			{ data : 'printIssueDate', width: '125px', defaultContent : '', orderable: true, className: 'dt-left' },
			{ data : 'printPublishName', width: '225px', defaultContent : '' }, 			 
			{ data : 'printArtName', width: '225px', defaultContent : '', className: 'dt-light' }
		];
	}
	...
	function initTrendsList() {
		...
		$('#webPostTable').dataTable({
			...
			destroy 		: true,
			ajax 			: {
				url 		: '<%=request.getContextPath()%>/rest/printsList',
				dataType 	: 'json',
