...
@Repository
@Transactional
public class GalleryRepositoryImpl2 implements GalleryRepositoryCustom {
...
//				"and cr.companyID =:companyID ";
		String queryStr = "SELECT DISTINCT  uif.link, uif.id,uif.text,uif.likes_count as likesCount, uif.standard_image as standardImage, "+
				"uif.comments_count as commentsCount, u.userid,u.state, u.FirstLastname as firstLastname, uif.created_time as createdTime,um.social_type  " + 
				"FROM user_instagram_feed uif " + 
