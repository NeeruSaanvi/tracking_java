		...
		<div class="kt-portlet kt-portlet--mobile">
			...
			<div class="kt-portlet__body">
				<table class="table table-striped- table-bordered table-hover table-checkable" id="webPostTable">
					<thead>
                       	<tr>
                       		<th class="dt-header-left">Action</th>
                            <th class="dt-header">Member Name</th>
                            <th class="dt-header">Date</th>
                            <th class="dt-header">Tournament Name</th>
                            <th class="dt-header">Final Place</th>
                          </tr>
                    	</thead>
                    <tbody>
                    </tbody>
...
<script type="text/javascript">
	...
	function getWebPostColumnData() {
		return [
			{ data : 'tournamentId', width: '100px', render: editDeleteBankAccountRenderer, defaultContent : '', className: 'dt-left' },
			{ data : 'treferenceName', width: '325px', defaultContent : '' },
			{ data : 'tournamentDate', width: '125px', defaultContent : '', className: 'dt-left' },
			{ data : 'tournamentTitle', width: '225px', defaultContent : '', orderable: true, className: 'dt-left' },
			{ data : 'tfinishedPlace', width: '125px', defaultContent : '', className: 'dt-left' },
	...
	function initTrendsList() {
		...
		$('#webPostTable').dataTable({
			...
			destroy 		: true,
			ajax 			: {
				url 		: '<%=request.getContextPath()%>/rest/tournamentsList',
				dataType 	: 'json',
