...
@Repository
@Transactional
public interface UserProAppDetailsRepository extends JpaRepository<UserProAppDetails, Long> {

	public UserProAppDetails findByUserIdAndCompanyId(Long userId, Long companyId);
